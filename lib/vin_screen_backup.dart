...
class _VinFlowScreenState extends State<VinFlowScreen> {
  ...
  Future<void> _resolveVin() async {
    ...
    try {
      final res = await svc.resolveVin(vin);
      ...
      if (status == 'AMBIGUOUS' && vehicleCandidates != null && vehicleCandidates.isNotEmpty) {
      ...
      if (engineChoices != null && engineChoices.isNotEmpty) {
